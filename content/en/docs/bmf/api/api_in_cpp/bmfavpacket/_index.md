...
[//]: <> (REF_MD: classbmf__sdk_1_1BMFAVPacket.html)
  ...
  [Public Member Functions](#public-member-functions)  |  [Static Public Member Functions](#static-public-member-functions)  |  [Public Attributes](https://babitmf.github.io/docs/bmf/api/api_in_cpp/bmfavpacket/#public-attributes)   
 ...
 ###  copy_props()
   ...
   ```
   copy all extra props(set by member func set_xxx) from  `from` (deepcopy if needed), 
   **Parameters**
   - **from**  
 ...
 ###  make()
   ...
   ```
    static BMFAVPacket bmf_sdk::BMFAVPacket::make( 
      int size, 
      Options &&... opts 
    )   
   ```
