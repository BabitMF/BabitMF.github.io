...
[//]: <> (REF_MD: classbmf__sdk_1_1BMFAVPacket.html)
  ...
  [公有成员函数](#公有成员函数)  |  [静态公有成员函数](#静态公有成员函数)  |  [Public Attributes](https://babitmf.github.io/docs/bmf/api/api_in_cpp/bmfavpacket/#public-attributes)   
 ...
 ###  make()
   ...
   ```
    static BMFAVPacket bmf_sdk::BMFAVPacket::make( int size,  Options &&... opts )   
   ```
   inlinestaticinline
