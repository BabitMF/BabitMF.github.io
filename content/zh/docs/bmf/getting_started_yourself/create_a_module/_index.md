...
BMF 的内置模块包括常用的视频处理模块，开发者可以直接使用这些模块来实现视频应用，包括基于 FFmpeg 的解码器、滤镜和编码器模块，以及更多 GPU 处理模块。有关内置模块的详细说明，请参阅 [ffmpeg_fully_compatible](https://babitmf.github.io/docs/bmf/multiple_features/ffmpeg_fully_compatible/)<!-- and [gpu_modules_introduction]()-->.
